...
Page {
    ...
    actions: [
        ActionItem {
            id: backItem
            title: qsTr("F A Q") + Retranslate.onLanguageChanged
            enabled: false
            imageSource: "asset:///images/faq.png"
        ...
        ActionItem {
            id: addQuestion
            title: qsTr("new Question") + Retranslate.onLanguageChanged
            imageSource: "asset:///images/new_question.png"
            enabled: true
            ActionBar.placement: ActionBarPlacement.OnBar
            // we reset the URL
            onTriggered: {
                ods.sendMail(qsTr("Question"))
            }
        },
        ActionItem {
            id: sendBug
            title: qsTr("Bugreport") + Retranslate.onLanguageChanged
            imageSource: "asset:///images/report_bug.png"
            enabled: true
            ActionBar.placement: ActionBarPlacement.InOverflow
            // we reset the URL
            onTriggered: {
                ods.sendMail(qsTr("Bugreport"))
            }
        },
        ActionItem {
