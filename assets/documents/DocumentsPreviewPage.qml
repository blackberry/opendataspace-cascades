...
Page {
    ...
    function reLayout(orientation) {
        if (orientation == UIOrientation.Landscape) {
            console.debug("DocumentsPreview: reLayout to LANDSCAPE")
            ...
            console.debug("DocumentsPreview: reLayout to LANDSCAPE DONE")
        } else {
            console.debug("DocumentsPreview: reLayout to PORTRAIT")
            ...
            console.debug("DocumentsPreview: reLayout to PORTRAIT DONE")
        }
    }
