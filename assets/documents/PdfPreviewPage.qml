...
Page {
    ...
    attachedObjects: [
        ...
        OrientationHandler {
            onOrientationAboutToChange: {
                console.debug("PdfPreview: onOrientationAboutToChange")
    ...
    ScrollView {
        Container {
            ...
            Container {
                ...
                ImageView {
                    id: previewImage
                    objectName: "previewPdf"
                    layoutProperties: StackLayoutProperties {
                    }
                    verticalAlignment: VerticalAlignment.Center
                    imageSource: "asset:///images/nuvola/pdf.png"
                    minWidth: 128
                    minHeight: 128
    ...
    function reLayout(orientation) {
        if (orientation == UIOrientation.Landscape) {
            console.debug("PdfPreview: reLayout to LANDSCAPE")
            ...
            console.debug("PdfPreview: reLayout to LANDSCAPE DONE")
        } else {
            console.debug("PdfPreview: reLayout to PORTRAIT")
            ...
            console.debug("PdfPreview: reLayout to PORTRAIT DONE")
        }
    }
